...
We will be using the expression $2x + z - z$ as an example where $x = [0, 1], z = [1, 3]$. This mean we have $2 * [0, 1] + [1, 3] - [1, 3]$. Applying the scaling rule and subtraction is negated addition gives us $[2 * 0, 2 * 1] + [1, 3] + (-1 * [1, 3])$ -- we can now simplify to $[0, 2] + [1, 3] + [-3, -1]$ and sup it all up to $[-2, 4]$
