...
\Todo{Section about how each variable is opaque}
\section{Results}
...
\Todo{Mention something about the implementation using BigInt and BigRational -- this should also give more discussion.}
