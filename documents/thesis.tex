...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Method}
The method chapter gives a high level overview of the method used in this paper. More detailed steps are delegated to the separate chapters. Chapter \ref{cha:Implementation} contains implementation details and chapter \ref{cha:ImplementationEval} contains evaluation of the implementation.
